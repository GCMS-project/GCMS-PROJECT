...
const BellIcon = ({ className }: { className?: string }) => (
  <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-5 5v-5zM4.19 4.19A2 2 0 004 6v10a2 2 0 002 2h10a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-1.81 1.19zM4 6h16M4 10h16M4 14h16M4 18h16" />
  </svg>
);
      ...
      `}>
        ...
        <nav className="flex-1 overflow-y-auto py-4">
          <ul className="space-y-1 px-3">
            ...
            {/* Pickup Management */}
            {(user?.role === 'admin' || user?.role === 'picker') && (
              <li>
                <a
                  href="/pickups"
                  className="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white transition-colors"
            ...
            {(user?.role === 'admin' || user?.role === 'dumpsite_officer') && (
              <li>
                <a
                  href="/dumpsites"
                  className="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white transition-colors"
                >
                  ...
                  <span>Dump Site Management</span>
                </a>
              </li>
            )}

            {/* Tender Management */}
            {(user?.role === 'admin' || user?.role === 'tender_officer') && (
              <li>
                <a
                  href="/tenders"
                  className="flex items-center space-x-3 px-3 py-2 rounded-lg text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white transition-colors"
        ...
        <div className="p-4 border-t border-gray-700">
          <button
            ...
            className="flex items-center space-x-3 w-full px-3 py-2 rounded-lg text-sm font-medium text-gray-300 hover:bg-gray-700 hover:text-white transition-colors"
          >
